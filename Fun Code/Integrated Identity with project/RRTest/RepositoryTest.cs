...
namespace RRTest
{
    ...
    {
        private readonly DbContextOptions<RRIdentityDbContext> _options;
        public RepositoryTest()
        {
            _options = new DbContextOptionsBuilder<RRIdentityDbContext>()
        ...
        {
            using (var context = new RRIdentityDbContext(_options))
            {
                //Arrange
        ...
        public void AddRestaurantShouldAddARestaurant()
        {
            ...
            //Assert
            using (var contexts = new RRIdentityDbContext(_options))
            {
